...
*NOTE:* Although the compiler itself is licensed under the GPLv3, the code
generated by the compiler is not. Feel free to use the generated C or RISC
code however you see fit, although it comes with no warranty, express or
implied.

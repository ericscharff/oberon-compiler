...
void pool_test(void) {
  ...
  assert((one - string_pool) == 227 + 0);
  assert((two - string_pool) == 227 + 4);
  assert((three - string_pool) == 227 + 8);
  assert((four - string_pool) == 227 + 14);

...
$(BUILDDIR)/oberonr: $(BUILDDIR)/oberon $(COMPILER_SRCS)
	...
	$(CC) $(CFLAGS) -o $(@) -Icompiler $(BUILDDIR)/rcompiler.c
...
$(BUILDDIR)/oberon1: $(BUILDDIR)/oberon0 $(COMPILER_SRCS)
	...
	$(CC) $(CFLAGS) -o $(@) -Icompiler $(BUILDDIR)/compiler0.c
